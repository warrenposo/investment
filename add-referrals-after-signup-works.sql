-- ============================================
-- STEP 2: Add Referral System (ONLY run this AFTER signup works)
...
-- Drop existing constraint if it exists, then create it
DO $$ 
BEGIN
...
-- Step 9: Update handle_new_user function WITH referral support
...
-- Users will get referral codes automatically
-- ============================================
